...
namespace STL.PL.WS3 {
    ...
    public partial class WCustomerManager : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public System.Data.DataSet CustomerSearch(string customerID, string firstName, string lastName, string address, string phoneNumber, int limit, int settled, bool exactMatch, string storeType, string source, out string err) {
