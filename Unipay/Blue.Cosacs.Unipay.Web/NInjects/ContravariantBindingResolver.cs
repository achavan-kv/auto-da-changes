...
Author: Suresh -IGT
Date: Feb 1st
Description:JM BlueStart-Pre-Qualification API -Returns any bindings from the specified collection that match the specified service.
 */
using System;
...
namespace Blue.Cosacs.Unipay.Web.NInjects
{
